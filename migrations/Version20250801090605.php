 ...
 */
final class Version20250801090605 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE starship_part CHANGE relation_id starship_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE starship_part CHANGE starship_id relation_id INT NOT NULL');
        $this->addSql('ALTER TABLE starship_part ADD CONSTRAINT FK_41C447373256915B FOREIGN KEY (relation_id) REFERENCES starship (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
